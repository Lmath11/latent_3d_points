...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--ckpt_path', type=str, default='/content/drive/MyDrive/ResultadosLothar/Checkpoints/GAN/airplane_chair/', help='Checkpoint path.')
        self._parser.add_argument('--ckpt_save', type=str, default='rGAN_plane_chair_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str,default='rGAN_plane_chair_ckpt_15.pt' , help='Checkpoint name to load.')
