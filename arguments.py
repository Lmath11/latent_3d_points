...
class Arguments:
    def __init__(self):
        ...
        # Dataset argument
        self._parser.add_argument('--dataset_path', type=str, default='/content/shapenetcore_partanno_segmentation_benchmark_v0_balanceado', help='Dataset file path.')
        ...
        self._parser.add_argument('--ckpt_save', type=str, default='TreeGAN_Balanceado_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str, default='TreeGAN_Balanceado_ckpt_104.pt', help='Checkpoint name to load.')
