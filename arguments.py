...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--ckpt_save', type=str, default='rGAN_cap_earphone_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str,default='rGAN_cap_earphone_ckpt_2000.pt' , help='Checkpoint name to load.')
