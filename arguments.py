...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--point_num', type=int, default=5096, help='Integer value for number of points.')
        ...
        self._parser.add_argument('--ckpt_path', type=str, default='/content/drive/MyDrive/ResultadosLothar/Treegan/All/', help='Checkpoint path.')
        self._parser.add_argument('--ckpt_save', type=str, default='TreeGAN_All_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str, default='TreeGAN_All_ckpt_55.pt', help='Checkpoint name to load.')
